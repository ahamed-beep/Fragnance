          ...
          >
            ...
            <div className="absolute bottom-2 sm:bottom-3 right-2 sm:right-3 flex">
              <button className="flex overflow-hidden rounded-full shadow">
                {/* Box (White Side) */}
                <span className="flex items-center justify-center w-8 h-8 sm:w-15 sm:h-15 bg-white hover:bg-gray-100">
                  <Box className="w-4 h-4 sm:w-5 sm:h-5 text-gray-700" />
                </span>

                {/* Arrow (Black Side) */}
                <span className="flex items-center justify-center w-8 h-8 rounded-full sm:w-15 sm:h-15 p-4 bg-black text-white hover:bg-gray-800">
                  <ArrowUpRight className="w-10 h-10 sm:w-10 sm:h-10 " />
                </span>
              </button>
            </div>
          </div>
